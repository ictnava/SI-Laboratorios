...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    $id=$_GET['id'];
        $sql ="UPDATE peliculas SET id ='".$id."', nombre ='".$nombre."', foto= '".$filedestino."', descripcion = '".$Descripcion.
        "', anio = ".$anio.", director = '".$Director."', categoria = '".$categoria."', duracion ="
        .$Duracion.", fecha = '".$fecha."' WHERE id = ".$id;
