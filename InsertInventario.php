<?php
        ...
        && isset($_REQUEST['hora']))
    {
        ...
        $qry = "INSERT INTO inventario (ClaveLab, idArticulo, Cantidad, noLocal) VALUES (:claveu, :clavelab, :fech, :hra)";
        ...
        {
            $bd->desconectar();
            header("Location: inventario.php?msg=Se registró la entrada con éxito");
        }
    }
    else
    {
